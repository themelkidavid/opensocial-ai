...
@dataclass
class EvidencePack:
 title:str; subject_type:str; subject_id:str; evidence_records:List[Dict]=field(default_factory=list); evidence_quality_summary:List[Dict]=field(default_factory=list); evidence_gaps:List[Dict]=field(default_factory=list); conflicts:List[Dict]=field(default_factory=list); patterns:List[Dict]=field(default_factory=list); insights:List[Dict]=field(default_factory=list); programme_references:List[str]=field(default_factory=list); mechanism_references:List[str]=field(default_factory=list); outcome_metrics:List[Dict]=field(default_factory=list); observations:List[Dict]=field(default_factory=list); provenance:Optional[str]=None; known_limitations:List[str]=field(default_factory=list); generated_at:Optional[str]=None; pack_id:Optional[str]=None; source_hypothesis_ids:List[str]=field(default_factory=list)
 def to_dict(self): return asdict(self)
 def finalized(self): return EvidencePack(**{**self.to_dict(),"pack_id":self.pack_id or _id("evidence-pack",self.to_dict())})
@dataclass
class DecisionBrief:
 title:str; subject_type:str; subject_id:str; purpose:str; problem_summary:Optional[str]=None; evidence_pack_id:Optional[str]=None; scenarios_considered:List[Dict]=field(default_factory=list); alternatives_considered:List[str]=field(default_factory=list); reviews:List[Dict]=field(default_factory=list); concerns:List[str]=field(default_factory=list); dissent_or_reservations:List[str]=field(default_factory=list); unresolved_questions:List[str]=field(default_factory=list); active_decision:Optional[Dict]=None; authorization_state:List[Dict]=field(default_factory=list); expected_learning:List[str]=field(default_factory=list); key_uncertainties:List[str]=field(default_factory=list); provenance:Optional[str]=None; generated_at:Optional[str]=None; brief_version:int=1; brief_id:Optional[str]=None; source_hypothesis_ids:List[str]=field(default_factory=list)
 def to_dict(self): return asdict(self)
